    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form action="adminLogin.php" class="login100-form validate-form" method="POST">
...
if(isset($_POST['loginbtn'])){
    $sql=$data->getdata("SELECT a_Id, a_Pass from admin where a_Id='".$_POST['id']."' and a_Pass='".$_POST['pass']."'");
